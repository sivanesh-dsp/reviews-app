    ...
    <div>
      ...
      <main className="mt-24 sm:mt-32 mb-10 bg-white p-10 m-2 rounded shadow">
        ...
        <ul className="py-5 space-y-4">
          <li>
            <div className="youtube-card border  px-4 py-2 flex items-center space-x-4 rounded hover:border-sky-600 hover:text-sky-600">
              <svg
          ...
          <li>
            <div className="event-card border px-4 py-2 flex items-center space-x-4 rounded hover:border-sky-600 hover:text-sky-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="32"
                height="32"
